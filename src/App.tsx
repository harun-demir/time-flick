...
function App() {
  ...
  const func = async (userMessage: string) => {
    const endpoint =
      "https://hdem-mc68m1xm-eastus2.cognitiveservices.azure.com/";
    const modelName = "gpt-4.1";
    const deployment = "gpt-4.1-2025";
    const apiKey =
      "AcqPCyQMc6imX8aMEhtYimKpFEgaIcg7zW6DFYqpjjd6fBd9jJkQJQQJ99BFACHYHv6XJ3w3AAAAACOGHEXq";
  ...
  return (
    <div
      style={{
        ...
        overflow: "hidden",
        display: "flex",
        justifyContent: isModalOpen ? "flex-start" : "center",
      }}
    >
      {/* Fixed Header */}
      <header
      ...
      <div
        style={{
          display: "flex",
          alignItems: isModalOpen ? "flex-start" : "center",
          flexDirection: "column",
          marginTop: "150px",
          width: isModalOpen ? "30%" : "60%",
        }}
      >
          ...
          >
            {messages.length === 0 ? (
              ...
              >
                ...
                />
                <div
                  style={{ fontSize: "28px", fontWeight: 500, color: "white" }}
                >
                  Ne planlamak istersin?
                </div>
                <div
                  style={{ display: "flex", gap: "0.5rem", marginTop: "1rem" }}
                >
                  <button
                    onClick={() => handleButtonClick("Bu haftayı oluştur")}
                    style={{
                  ...
                  <button
                    onClick={() => handleButtonClick("Geçen haftayı kopyala")}
                    style={{
                      backgroundColor: "rgba(59, 130, 246, 0.1)",
                      border: "1px solid rgba(59, 130, 246, 0.5)",
                      color: "white",
                  ...
                  <button
                    onClick={() => handleButtonClick("Taskları göster")}
                    style={{
                      backgroundColor: "rgba(59, 130, 246, 0.1)",
                      border: "1px solid rgba(59, 130, 246, 0.5)",
                      color: "white",
                  ...
                  <button
                    onClick={() =>
                      handleButtonClick("Toplantılardan efor oluştur")
                    }
                    style={{
                      backgroundColor: "rgba(59, 130, 246, 0.1)",
                      border: "1px solid rgba(59, 130, 246, 0.5)",
                  ...
                  >
                    Toplantılardan efor oluştur
                  </button>
                  <button
                    onClick={() => handleButtonClick("Eksik girişleri göster")}
                    style={{
                      backgroundColor: "rgba(59, 130, 246, 0.1)",
                      border: "1px solid rgba(59, 130, 246, 0.5)",
                      color: "white",
              ...
              >
                {messages.map((message, index) => {
                  ...
                  const messageStyle: React.CSSProperties = {
                    ...
                    maxWidth: "75%",
                    backgroundColor:
                      message.role === "user" ? "#3b82f6" : "#374151",
                    color: "white",
                  };
      ...
      {isModalOpen && <div className="w-full bg-[lightgrey]">
